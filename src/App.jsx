...
function App() {
	...
	return (
		<main className="flex flex-col gap-4 sm:gap-10 sm:flex-row font-sans border w-fit  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-xl rounded-md items-start">
